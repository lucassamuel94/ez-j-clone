...
-- 2. Immutable unaccent wrapper (needed for indexes)
...
-- 3. Update search_leads_paginated with fuzzy + unaccent search
...
-- 4. Update search_opportunities_paginated with fuzzy + unaccent search
