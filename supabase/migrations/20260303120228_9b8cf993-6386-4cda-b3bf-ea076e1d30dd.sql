...
-- Update search_opportunities_paginated to support unassigned filter via sentinel UUID
...
-- Update get_opportunity_tab_counts to support unassigned filter via sentinel UUID
