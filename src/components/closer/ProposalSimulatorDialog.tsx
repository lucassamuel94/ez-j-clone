    ...
    try {
      ...
      const { data: proposal, error } = await supabase
        ...
        .insert({
          ...
          plan_messages_included: recommended.messagesIncluded,
          plan_contacts_included: recommended.contactsIncluded,
          plan_excess_message_price: recommended.excessMessagePrice,
          plan_excess_contact_price: recommended.excessContactPrice,
          ...
          excess_messages: simulation.excessMessages,
          excess_contacts: simulation.excessContacts,
          excess_message_cost: simulation.excessMessageCost,
          excess_contact_cost: simulation.excessContactCost,
          applied_excess_cost: simulation.appliedExcessCost,
